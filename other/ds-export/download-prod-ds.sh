...
/usr/local/bin/appcfg.py download_data --config_file=bulkloader.yaml --filename=./ds-download/swagclip_export_clip.csv --kind=Clip --url=http://swagclip.appspot.com/_ah/remote_api
