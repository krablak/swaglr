...
consumer_key, consumer_secret, oauth_scope, opt_args,extension_name) {
...
ChromeExOAuth.prototype.clearTokens = function() {
    alert("clearTokens not implemented!");
...
ChromeExOAuth.prototype.setToken = function(token) {
    ...
    return prefs.setCharPref(this.extension_name +".request_token",token);
};
/**
...
ChromeExOAuth.prototype.getToken = function() {
    var prefs = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch);
    return prefs.getCharPref(this.extension_name+".request_token");
};
/**
...
ChromeExOAuth.prototype.setTokenSecret = function(secret) {
    var prefs = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch);
    return prefs.setCharPref(this.extension_name +".request_token_secret",secret);
};
/**
...
ChromeExOAuth.prototype.getTokenSecret = function() {
    var prefs = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch);
    return prefs.getCharPref(this.extension_name+".request_token_secret");
};
/**
